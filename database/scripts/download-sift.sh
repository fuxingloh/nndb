...
# Extracts to database/data/sift/{sift_base.fvecs,sift_query.fvecs,sift_groundtruth.ivecs,sift_learn.fvecs}
set -euo pipefail
...
if [ ! -f sift.tar.gz ]; then
  ...
  # http://corpus-texmex.irisa.fr/ and drop it in database/data/
