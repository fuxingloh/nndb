...
const ROWS = [
  ...
  { name: "1-bit code — 128 B/vec", mb: 128, color: "#5ccfe6", note: "32× smaller — fits the bus" },
];
const max = ROWS[0].mb;
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="border-t border-border pt-3 text-[13px] leading-6 text-dim">
        ...
        <span className="text-cyan"> fewer bytes</span>. 1-bit is a <span className="text-cyan">32×</span> cut.
      </p>
    </div>
  );
}
