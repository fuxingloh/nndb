...
- **The regime flipped**: at 31.7 MB the codes are cache-resident, the scan turns *compute*-bound, and tiling — +73% on the 1024-bit funnel — now *costs* 24%. Every byte reduction re-prices every lever (the 003→007 cascade, one more time).
...
- **Corpus shape** — how big, what embedding, what dim, how fast it grows and churns. The 064 wall and the Matryoshka result both say the *data* decides the design, not the engine.
